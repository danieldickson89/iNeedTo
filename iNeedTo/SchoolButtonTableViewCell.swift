//
//  SchoolButtonTableViewCell.swift
//  iNeedTo
//
...
class SchoolButtonTableViewCell: UITableViewCell {
    ...
    var delegate: SchoolButtonTableViewCellDelegate?
...
protocol SchoolButtonTableViewCellDelegate {
    
    func buttonCellButtonTapped(sender: SchoolButtonTableViewCell)
}

extension SchoolButtonTableViewCell {
